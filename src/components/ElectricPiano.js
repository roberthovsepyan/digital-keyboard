...
class ElectricPiano extends Component {
    constructor () {
        super();
    ...
    render() {
        return (
            <Wrapper tabIndex={0} ref='keyboard' onKeyDown={this.handleKeyDown} onKeyUp={this.handleKeyUp}>
                ...
                <KeyboardWrapper>
                    <WhiteKey active={this.state.keys.A} text='A' color='#CE93D8'/>
                    <WhiteKey active={this.state.keys.S} text='S' color='#CE93D8'/>
                    <WhiteKey active={this.state.keys.D} text='D' color='#CE93D8'/>
                    <WhiteKey active={this.state.keys.F} text='F' color='#CE93D8'/>
                    <WhiteKey active={this.state.keys.G} text='G' color='#CE93D8'/>
                    <WhiteKey active={this.state.keys.H} text='H' color='#CE93D8'/>
                    <WhiteKey active={this.state.keys.J} text='J' color='#CE93D8'/>
                    <WhiteKey active={this.state.keys.K} text='K' color='#CE93D8'/>
                    <WhiteKey active={this.state.keys.L} text='L' color='#CE93D8'/>
                    <WhiteKey active={this.state.keys[';']} text=';' color='#CE93D8'/>
                    <WhiteKey active={this.state.keys["'"]} text="'" color='#CE93D8'/>
                    <BlackKey active={this.state.keys.W} text='W' left='24px' color='#AA00FF'/>
                    <BlackKey active={this.state.keys.E} text='E' left='60px' color='#AA00FF'/>
                    <BlackKey active={this.state.keys.T} text='T' left='132px' color='#AA00FF'/>
                    <BlackKey active={this.state.keys.Y} text='Y' left='168px' color='#AA00FF'/>
                    <BlackKey active={this.state.keys.U} text='U' left='204px' color='#AA00FF'/>
                    <BlackKey active={this.state.keys.O} text='O' left='276px' color='#AA00FF'/>
                    <BlackKey active={this.state.keys.P} text='P' left='312px' color='#AA00FF'/>
                </KeyboardWrapper>
                {this.props.children}
                </ContentWrapper>
            </Wrapper>
