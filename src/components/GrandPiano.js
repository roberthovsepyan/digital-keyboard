...
import keyC from '../sounds/C_piano.mp3';
import keyDb from '../sounds/Db_piano.mp3';
import keyD from '../sounds/D_piano.mp3';
import keyEb from '../sounds/Eb_piano.mp3';
import keyE from '../sounds/E_piano.mp3';
import keyF from '../sounds/F_piano.mp3';
import keyGb from '../sounds/Gb_piano.mp3';
import keyG from '../sounds/G_piano.mp3';
import keyAb from '../sounds/Ab_piano.mp3';
import keyA from '../sounds/A_piano.mp3';
import keyBb from '../sounds/Bb_piano.mp3';
import keyB from '../sounds/B_piano.mp3';
import keyC2 from '../sounds/C2_piano.mp3';
import keyDb2 from '../sounds/Db2_piano.mp3';
import keyD2 from '../sounds/D2_piano.mp3';
import keyEb2 from '../sounds/Eb2_piano.mp3';
import keyE2 from '../sounds/E2_piano.mp3';
import keyF2 from '../sounds/F2_piano.mp3';
...
const Wrapper = styled.div`
    ...
    position: relative;
    height: 100vh;
    background: linear-gradient(to bottom, #B2FF59, #1B5E20);
`;
...
class GrandPiano extends Component {
    constructor () {
        super();
        ...
        return (
            <Wrapper tabIndex={0} ref='keyboard' onKeyDown={this.handleKeyDown} onKeyUp={this.handleKeyUp}>
                <ContentWrapper>
                    ...
                    <KeyboardWrapper>
                        <WhiteKey active={this.state.keys.A} text='A' color='#AED581'/>
                        <WhiteKey active={this.state.keys.S} text='S' color='#AED581'/>
                        <WhiteKey active={this.state.keys.D} text='D' color='#AED581'/>
                        <WhiteKey active={this.state.keys.F} text='F' color='#AED581'/>
                        <WhiteKey active={this.state.keys.G} text='G' color='#AED581'/>
                        <WhiteKey active={this.state.keys.H} text='H' color='#AED581'/>
                        <WhiteKey active={this.state.keys.J} text='J' color='#AED581'/>
                        <WhiteKey active={this.state.keys.K} text='K' color='#AED581'/>
                        <WhiteKey active={this.state.keys.L} text='L' color='#AED581'/>
                        <WhiteKey active={this.state.keys[';']} text=';' color='#AED581'/>
                        <WhiteKey active={this.state.keys["'"]} text="'" color='#AED581'/>
                        <BlackKey active={this.state.keys.W} text='W' left='24px' color='#76FF03'/>
                        <BlackKey active={this.state.keys.E} text='E' left='60px' color='#76FF03'/>
                        <BlackKey active={this.state.keys.T} text='T' left='132px' color='#76FF03'/>
                        <BlackKey active={this.state.keys.Y} text='Y' left='168px' color='#76FF03'/>
                        <BlackKey active={this.state.keys.U} text='U' left='204px' color='#76FF03'/>
                        <BlackKey active={this.state.keys.O} text='O' left='276px' color='#76FF03'/>
                        <BlackKey active={this.state.keys.P} text='P' left='312px' color='#76FF03'/>
                    </KeyboardWrapper>
                    {this.props.children}
                </ContentWrapper>
            </Wrapper>
